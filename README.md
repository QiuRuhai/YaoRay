...
Final path tracing quality, spectral rendering, glass, roughness, texture import, imported asset materials, soft shadows, advanced BVH split methods, glTF/GLB import, HDR output, and real CUDA backend support are planned as separate implementation slices.
