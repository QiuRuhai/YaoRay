...
Final path tracing quality, spectral rendering, glass refraction, texture import, imported asset materials, advanced BVH split methods, glTF/GLB import, HDR output, and real CUDA backend support are planned as separate implementation slices.
